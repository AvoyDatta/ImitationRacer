...
class Agent:
    ...
    def train(self, X_train, y_train, X_valid, y_valid, n_batches, batch_size, lr, n_epochs, display_step, ckpt_step, ckpt_path, seed):
        print("Training model")
        self.model.train(X_train, y_train, X_valid, y_valid, n_batches, batch_size, lr, n_epochs, display_step, ckpt_step, ckpt_path, seed)
